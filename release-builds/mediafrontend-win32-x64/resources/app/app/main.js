...
var app = new Vue({
    ...
    methods: {
        ...
        scanForController: function scanForController() {
            this.$modal.show('nocontroller');
        },
        mapControllerEvents: function mapControllerEvents() {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("modal", { attrs: { name: "loading", width: "500", height: "130" } }, [
        _c("div", { staticClass: "loading-modal" }, [
          _c("i", { staticClass: "fas fa-spin fa-cog" }),
          _vm._v(" "),
          _c("span", [
            _vm._v("Opening " + _vm._s(_vm.selectedApplication.name) + " ...")
          ])
        ])
      ]),
      _vm._v(" "),
